...
class Camera
{
    ...
    mat4	view;
      ...
      Camera(bool active = true,  GLuint programID = 0,  GLuint type = 0, GLfloat left = 0.0f, GLfloat right = 256.0f, GLfloat bottom = 0.0f, GLfloat top = 240.0f, GLfloat zNear = 1000.0f , 
      ...
      GLfloat upY = 1.0f, GLfloat upZ = 1.0f);
      ~Camera();

      void initCamera(bool active, GLuint programID,  GLuint type, GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar, GLfloat eyeX, GLfloat eyeY, GLfloat eyeZ, 		GLfloat centerX, GLfloat centerY, GLfloat centerZ, GLfloat upX, GLfloat upY, GLfloat upZ);
