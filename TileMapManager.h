...
class TileMapManager
{
	...
	__declspec(dllexport) TileMapManager(GLuint mapDataCount = 1, GLuint pageTiles = 224, GLuint *mapData = nullptr, GLuint vw = 256, GLuint vh = 224, GLuint tw = 16, GLuint th = 16, GLuint program = 0, GLenum mode = GL_TRIANGLES);
