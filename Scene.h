...
class Scene
{
    ...
    GLfloat viewportX = 0.0f, GLfloat viewportY = 0.0f, GLfloat viewportW = 256.0f, GLfloat viewportH = 224.0f, GLfloat zoom = 1.0f,
    GLuint type = 0, GLfloat left = 0.0f, GLfloat right = 256.0f, GLfloat bottom = 0.0f, GLfloat top = 224.0f,
